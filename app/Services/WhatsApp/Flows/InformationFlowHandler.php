...
class InformationFlowHandler
{
    ...
    {
        return "⚙️ Podemos recibir solicitudes relacionadas con motores aeronáuticos para:\n\n• Compra\n• Venta\n• Reparación\n• Overhaul\n• Exchange\n• Inspección\n\nPara registrar una solicitud, vuelve al menú principal y selecciona Motores.";
    }
